...
<html>
    ...
    <body>
        ...
        <div class="row-fluid" style="margin-top: 0em;">
            <p class="simple-text lead">Ompli este q&uuml;estionari per a avaluar la qualitat del proc&eacute;s de matricula.</p>
            <p class="simple-text lead">L'enquesta &eacute;s an&ograve;nima i les dades aportades seran tractades de forma confidencial.Esta informaci&oacute; ens ser&agrave; molt &uacute;til per a millorar el proc&eacute;s de matricula del pr&ograve;xim curs.</p>
